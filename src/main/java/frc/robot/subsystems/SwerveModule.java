...
public class SwerveModule extends SubsystemBase {
  ...
  private final TrapezoidProfile.Constraints m_turningConstraints = new TrapezoidProfile.Constraints(Math.PI, 2 * Math.PI);
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    m_turningMotor.set(ControlMode.Position, state.angle.getDegrees(), DemandType.ArbitraryFeedForward, m_turnFeedforward.calculate(m_setpoint.velocity));
  }
