...
public final class Constants {
  ...
  public static final double kMaxSpeed = 8.0; // meters per second
  ...
  public static enum AutoMode{
      AP, PATH_BOTTOM, PATH_BOTTOM_HOMING, PATH_BOTTOM_MIDDLE_HOMING, PATH_BOTTOM_MIDDLE, PATH_MIDDLE, PATH_MIDDLE_HOMING, PATH_MIDDLE_BOTTOM_HOMING, PATH_MIDDLE_BOTTOM, PATH_TOP, PATH_TOP_MIDDLE, PATH_MIDDLE_TOP
  }
  ...
  public static final double EmissionMaxSpeed = 10;   // Ball Emission Max Speed in meters/second
  public static final double ShooterSpeedError = 1000;  // Shooter Speed Error in pulse/100ms
