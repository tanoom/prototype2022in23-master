...
public class Dashboard extends SubsystemBase {
  ...
  public Dashboard(DriveTrain source1, Compressor source2, Turret source3, LimeLight source4) {
    ...
    m_dbSendable = new DBSendable(source4);
  ...
  public void periodic() {
    ...
    try{
      RobotContainer.m_autoMode = Constants.AutoMode.valueOf(SmartDashboard.getString("Auto Selector", RobotContainer.m_autoMode.name()));
    }catch(Exception e){}
